			...
			.extend({
				show : function(J, L) {
					if (J) {
						...
						for ( var H = 0, F = this.length; H < F; H++) {
							this[H].style.display = o.data(this[H],
									"olddisplay")
									|| "";
						}
						return this;
				...
				hide : function(H, I) {
					if (H) {
						...
						for ( var G = 0, F = this.length; G < F; G++) {
							...
							if (!E && E !== "none") {
								o.data(this[G], "olddisplay", o.css(this[G],
										"display"));
							}
						}
						for ( var G = 0, F = this.length; G < F; G++) {
				...
				toggle : function(G, F) {
					...
					return o.isFunction(G) && o.isFunction(F) ? this._toggle
							.apply(this, arguments) : G == null || E ? this
							.each(function() {
